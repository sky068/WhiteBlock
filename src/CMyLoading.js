...
MyLoadingScene = cc.Scene.extend({
    ...
    init : function(){
        ...
        progressLength = self._progressLength = GC.size.width-100;
        var progress = self._progressLayerColor = new cc.LayerColor(cc.color(255,255,0,255),5,30);
        ...
        label.setPosition(cc.p(GC.size.width/2,label.getContentSize().height));
