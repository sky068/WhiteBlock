var CSuccess = CPopLayerRoot.extend({
    _bgLayer:null,
    ctor:function()
    {
        this._super();
    ...
    {
        var come = new cc.LabelTTF("挑战成功!","Arial",30);
        ...
        var lose = new cc.LabelTTF("果然是一个牛A与牛C之间的人!","Arial-BoldMT",25);
        ...
        //添加菜单
        var label = new cc.LabelTTF("再来一次","Arial",36);
